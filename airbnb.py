...
def datafr():
    df= pd.read_csv("C:/Users/nitis_x7geczv/Downloads/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:/Users/nitis_x7geczv/Downloads/airbnbim.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/nitis_x7geczv/Downloads/Airbnb.csv")
            return df_a
